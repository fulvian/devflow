#!/usr/bin/env python3
"""Session start hook to initialize Claude Code Sessions context v2.0"""
import json
import os
import sys
import subprocess
...
from standard_hook_pattern import BaseDevFlowHook, UserPromptSubmitHook
