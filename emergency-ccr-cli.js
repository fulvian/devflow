...
Quick Start:
  ...
  node emergency-ccr-cli.js start

  # Then use CCR for coding:
  npx @musistudio/claude-code-router code "your coding request"

  # When Claude Code is available again:
  node emergency-ccr-cli.js stop

Examples:
  node emergency-ccr-cli.js start
  node emergency-ccr-cli.js test
  node emergency-ccr-cli.js monitor
...
async function main() {
  ...
  switch (command) {
    ...
    case '-h':
      ...
      break;
    default:
      console.log('❓ Unknown command. Use "node emergency-ccr-cli.js help" for usage information.');
      exitCode = 1;
  }
...
module.exports = { EmergencyCCRCLI };