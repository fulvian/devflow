...
const syntheticCommandHandler = async (args) => {
...
const syntheticCodeCommandHandler = async (args) => {
    const { prompt, options } = parseCommandArguments(args);
    const syntheticCommand = new SyntheticCommand();
    try {
...
const syntheticReasoningCommandHandler = async (args) => {
    const { prompt, options } = parseCommandArguments(args);
    const syntheticCommand = new SyntheticCommand();
    try {
...
const syntheticContextCommandHandler = async (args) => {
    const { prompt, options } = parseCommandArguments(args);
    const syntheticCommand = new SyntheticCommand();
    try {
...
const syntheticStatusCommandHandler = async (args) => {
    const syntheticCommand = new SyntheticCommand();
    try {
...
const syntheticHelpCommandHandler = async (args) => {
    const syntheticCommand = new SyntheticCommand();
    try {
...
export function registerSyntheticCommands() {
...
//# sourceMappingURL=synthetic-command-registry.js.map