...
export class ZTAToolInterceptor {
    ...
    // ================================================================================================
    async interceptToolCall(context) {
    ...
    extractBashCommand(args) {
        return args.command || args.cmd || '';
    }
    detectHiddenCodingPatterns(context) {
    ...
    determineSuggestedAgent(context) {
    ...
    // ================================================================================================
    generateDelegationPrompt(originalPrompt, suggestedAgent) {
...
`;
    ...
    updateSecurityLog(type, context, riskLevel) {
    ...
    recordPerformanceMetrics(toolName, processingTime) {
    ...
    isHealthy() {
        ...
        if (avgPerformance > 50)
            return false; // >50ms is concerning
        return true;
    }
}
// ================================================================================================
...
export function createZTAInterceptor(config) {
    if (!interceptorInstance) {
        interceptorInstance = new ZTAToolInterceptor(config);
    }
    return interceptorInstance;
}
export function getZTAInterceptor() {
    if (!interceptorInstance) {
...
// ================================================================================================
export async function interceptToolCallGlobal(toolName, args, prompt, userInput) {
...
export function validateZTAConfiguration(config) {
