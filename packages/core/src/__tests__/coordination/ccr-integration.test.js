...
describe('CCR Session Independence', () => {
    ...
    describe('ContextPreservation', () => {
        it('should preserve context for CCR handoff', async () => {
            ...
            const preservedContext = await preservation.preserveForCCRHandoff(taskId, sessionId, 'claude_code');
        ...
        it('should create context snapshots', async () => {
            ...
            const snapshot = await preservation.createSnapshot(taskId, sessionId, 'claude_code', 'test');
...
//# sourceMappingURL=ccr-integration.test.js.map