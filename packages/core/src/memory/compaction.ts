import type { CompactionResult, MemoryCompactionStrategy, MemoryBlock } from '@devflow/shared';

export function compactContext(blocks: MemoryBlock[], strategy: MemoryCompactionStrategy, targetSize = 0.6): CompactionResult {
