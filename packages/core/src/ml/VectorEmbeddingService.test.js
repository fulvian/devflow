...
describe('VectorEmbeddingService', () => {
    ...
    describe('semantic search', () => {
      ...
      `);
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(block.id, block.taskId, block.sessionId, block.blockType, block.label, block.content, JSON.stringify(block.metadata), block.importanceScore, JSON.stringify(block.relationships), block.createdAt.toISOString(), block.lastAccessed.toISOString(), block.accessCount);
            }
...
//# sourceMappingURL=VectorEmbeddingService.test.js.map