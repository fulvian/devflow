 ...
 */
export type ModelType = 'sonnet' | 'codex' | 'gemini' | 'qwen';
...
/**
 * MCP client for managing Claude Code sessions and model switching
 */
export class MCPClient extends EventEmitter {
   ...
   */
  async sendMessageToModel(content: string, model?: ModelType): Promise<string> {
    if (!this.sessionId) {
